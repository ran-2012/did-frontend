...
import type {GetBip32PublicKeyParams} from '@metamask/snaps-sdk';
import type {GetBip32EntropyParams} from "@metamask/snaps-sdk/dist/types/types/methods/get-bip32-entropy";
